...
namespace BookShopSystem.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookShopSystem.Data.BookShopContext>
    {
        ...
        {
            using (var reader = new StreamReader("C:\\Users\\stil2\\Desktop\\Testing\\BookShopSystem-Solution\\BookShopSystem\\resources\\categories.txt"))
            {
        ...
        {
            using (var reader = new StreamReader("C:\\Users\\stil2\\Desktop\\Testing\\BookShopSystem-Solution\\BookShopSystem\\resources\\books.txt"))
            {
                var line = reader.ReadLine();
                line = reader.ReadLine();
                while (line != null)
        ...
        {
            using (var reader = new StreamReader("C:\\Users\\stil2\\Desktop\\Testing\\BookShopSystem-Solution\\BookShopSystem\\resources\\authors.txt"))
            {
                var line = reader.ReadLine();
                line = reader.ReadLine();
                while (line != null)
