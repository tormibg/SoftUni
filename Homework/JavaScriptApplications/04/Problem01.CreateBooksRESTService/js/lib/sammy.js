...
$.extend(Sammy.DefaultLocationProxy.prototype , {
  ...
  Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    // The default templates engine to use when using `partial()` in an
  ...
  // `Sammy.RenderContext` is an object that makes sequential templates loading,
  ...
  Sammy.RenderContext.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    // Load a templates into the context.
    ...
    // in invisible elements or `<script>` tags. With templates paths, the templates
    // engine is looked up by the extension. For DOM/jQuery embedded templates,
    // this isnt possible, so there are a couple of options:
    //
    //  * pass an `{engine:}` option.
    //  * define the engine in the `data-engine` attribute of the passed node.
    //  * just store the raw templates data and use `interpolate()` manually
    //
    // If a `callback` is passed it is executed after the templates load.
    ...
    // `load()` a templates and then `interpolate()` it with data.
    //
    ...
    //
    //      this.get('#/', function() {
    //        this.render('mytemplate.templates', {name: 'test'});
    //      });
    //
    ...
    // loads a templates, and then interpolates it for each item in the `data`
    ...
    // a templates. `engine` defines the templating/interpolation method/engine
  ...
  Sammy.EventContext.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    // * a templates path: 'templates.ejs', looks up the extension to match to
    //   the `ejs()` helper
    ...
    engineFor: function(engine) {
      ...
      // set the engine to the default templates engine if no match is found
    ...
    // using the templates `engine` found with `engineFor()`, interpolate the
    // `data` into `content`
    ...
    // Loads the templates and interpolate the data, however does not actual
    // place it in the DOM.
    //
    // ### Example
    //
    ...
    // Loads the templates and interpolates the data for each item,
    ...
    // element of the array (useful for referencing in templates).
    //
    // ### Example
    //
    //      // mytemplate.mustache <div class="name">{{name}}</div>
    ...
    //      // uses the templates to render each item in the JSON array
    //
    renderEach: function(location, name, data, callback) {
